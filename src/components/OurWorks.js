...
export default function OurWorks() {
    return (
        <section className="py-[106px] flex flex-col gap-16 XL:gap-16 XL:py-20 LG:py-12 LG:gap-12 MD:pt-8 MD:pb-10 MD:gap-6 1.5SM:gap-12">
            ...
            <Link href="/our-works" className="mx-auto">
                <Button className="bg-surface/accent text-white h-[52px] text-[18px] max-w-[154px] w-full LG:text-base mx-auto">
                    Узнать больше
                </Button>
            </Link>
        </section>
