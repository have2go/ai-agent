        ...
        <section className="grid grid-cols-2 py-10 XL:py-6 MD:grid-cols-1 MD:py-10">
            <div className="flex flex-col justify-center LG:mx-auto">
                ...
                <p className="text-[#9594a7] mt-10 mb-[76px] max-w-[360px] XL:mt-8 XL:mb-12 XL:text-[15px] LG:text-base LG:mt-6 LG:mb-8 MD:max-w-none MD:text-center 1.5SM:leading-5">
                    Самый простой способ создать AI-сотрудника,
                ...
                <div className="flex gap-6 items-center LG:gap-3 MD:mx-auto 1.5SM:flex-col 1.5SM:gap-8">
                    <Button
                        className="bg-surface/accent text-white h-[52px] text-[18px] max-w-[156px] w-full XL:text-base XL:h-12 XL:max-w-32 LG:text-sm LG:h-10 1.5SM:text-[18px] 1.5SM:max-w-[156px] 1.5SM:h-[52px]"
                        radius="lg"
                    >
                        Нанять
                    </Button>
                    <div className="flex gap-5 font-bold XL:text-base XL:gap-3 MD:gap-5 LG:text-sm 1.5SM:gap-4">
